        ...
        <>
            <section className="container mx-auto my-16">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-32 my-10">
                    <div className="flex flex-col gap-10 md:text-right items-center md:items-end cursor-default w-[300px]">
                        <div className="flex flex-col items-center md:items-end gap-3">
                            ...
                            <p className="text-xs max-w-[100px]">Franklin Rawson Oeste 2245, San Juan, Argentina</p>
                        </div>
                        <div className="flex flex-col items-end gap-3">
                            ...
                            <p className="text-xs max-w-[150px]">{'Mobile: +(84) 546-6789'}</p>
                        </div>
                        <div className="flex flex-col items-end gap-3">
                            <div className="flex gap-5 items-center font-semibold text-xl">
                                <Image
                            ...
                            <p className="text-xs max-w-[100px]">Monday-Friday: 9:00 - 22:00</p>
                            <p className="text-xs max-w-[100px]">Saturday-Sunday: 9:00 - 21:00</p>
                        </div>
                    </div>
                    <form className="flex flex-col gap-10">
                        <div className="flex flex-col gap-2 w-full">
                            ...
                            <input 
                                type="text" 
                                placeholder="Abc"
                                className="border border-[#ccc] p-2 rounded-md w-[400px]"
                            />
                        </div>
                        <div className="flex flex-col gap-2 w-full">
                        ...
                        <div className="flex flex-col gap-2 w-full">
                            ...
                            <textarea
                                ...
                                className="border border-[#ccc] p-2 rounded-md w-[400px] max-h-44"
                            />
                        </div>
